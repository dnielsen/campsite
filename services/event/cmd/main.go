...
import (
	...
	"campsite/packages/event/internal/database"
	"campsite/packages/event/internal/handler"
	"campsite/packages/event/internal/middleware"
	"campsite/packages/event/internal/server"
