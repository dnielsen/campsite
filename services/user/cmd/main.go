...
import (
	...
	"campsite/services/user/internal/database"
	"campsite/services/user/internal/handler"
	"campsite/services/user/internal/middleware"
	"campsite/services/user/internal/server"
